...
setInterval(function () {
    ...
    xmlParse = parser.parseFromString(fetchXmlQuery.innerText.replaceAll('\n', ''), "text/xml");
...
function testOnClick() {
    if (orgUrl.value === '') {
        ...
        testBtn.setAttribute("href", orgUrl.value + "/api/data/v9.2/" + entityName.value + "?fetchXml=" + fetchXmlQuery.innerText.replaceAll('\n', '').replace(/\s{2,}/g, ' '));
